...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-nt-045-the-number-of-idoneal-numbers-9fef53be-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NT-045"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-nt-045-the-number-of-idoneal-numbers-9fef53be-v1",
      "problem_contract_sha256": "8250d8c7675ab5ab6f18fa2d6d7320823599bd140afab5576a993c37a6b7b73f",
      "problem_id": "problem:um-nt-045-the-number-of-idoneal-numbers-9fef53be",
      "route_id": "route:um-nt-045-the-number-of-idoneal-numbers-9fef53be-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-nt-045-the-number-of-idoneal-numbers-9fef53be-source-fidelity-01",
      "graph_id": "graph:um-nt-045-the-number-of-idoneal-numbers-9fef53be-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-nt-045-the-number-of-idoneal-numbers-9fef53be-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-nt-045-the-number-of-idoneal-numbers-9fef53be-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are there exactly 65 idoneal numbers, or could there be 66 or 67?"
          },
          "statement_sha256": "a39d64f53674bddcdd9d6e6441a431969e8078c3df4f5e2dd7c5bdccdcc98219"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-nt-045-the-number-of-idoneal-numbers-9fef53be-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-nt-045-the-number-of-idoneal-numbers-9fef53be-root",
      "route_id": "route:um-nt-045-the-number-of-idoneal-numbers-9fef53be-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-nt-045-9b41a80e361f",
        "url": "https://www.unsolvedmath.com/problems/NT-045"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
